      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:w-3/4 mx-auto">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group bg-[#1A1A1A] p-6 rounded-2xl transition-all duration-300 hover:bg-gradient-to-br hover:from-[#8A2BE2]/10 hover:to-transparent hover:scale-105"
              data-aos="fade-up"
              data-aos-delay={index * 100}
            >
              <div className="w-12 h-12 mb-4 rounded-lg bg-gradient-to-br from-[#8A2BE2] to-[#9370DB] p-2.5 transition-transform group-hover:scale-110">
